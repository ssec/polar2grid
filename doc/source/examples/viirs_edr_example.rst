...
VIIRS Cloud Height (JRR-CloudHeight*.nc), VIIRS Cloud Base Height (JRR-CloudBase*.nc),
VIIRS Cloud Cover Layers (JRR-CloudCoverLayers*.nc), and VIIRS Land Surface Reflectance
...
For instance, if I want to create just an image of the Aerosol Optical Depth (AOD) for these
...
.. code-block:: bash
    ...
    polar2grid.sh -r viirs_edr -w geotiff -p CldTopTemp -f JRR-CloudHeight*.nc
...
.. figure:: ../_static/example_images/VIIRS_CTT_example_with_overlays1.png
    :name: VIIRS_CTT_example_with_overlays1.png
    :width: 100%
    :align: center
...
.. code-block:: bash
    ...
    polar2grid.sh -r viirs_edr -w geotiff -p CldTopHght -f JRR-CloudHeight*.nc

    add_coastlines.sh noaa20_viirs_CldTopHght_20240605_185031_wgs84_fit.tif \
    --add-colorbar --colorbar-text-color="black" \
    --colorbar-title="VIIRS Cloud Top Height (km)" --add-coastlines \
    --coastlines-outline "black" --coastlines-level 1 \
    --coastlines-resolution=i --add-borders --borders-level 2 \
    --borders-outline "gray" --borders-width 1 --coastlines-width 2 \
    --colorbar-height 125 --colorbar-text-size 100 \
    --colorbar-tick-marks 2.5 --colorbar-minor-tick-marks 1.0 \
    --colorbar-min 0. --colorbar-max 20.

And results in the creation of the following image:

.. raw:: latex

    \newpage

.. figure:: ../_static/example_images/VIIRS_CTH_example_with_overlays.png
    :name: VIIRS_TBH_example_with_overlays.png
    :width: 100%
    :align: center
...
.. code-block:: bash
    ...
    polar2grid.sh -r viirs_edr -w geotiff -p CldBaseHght -f JRR-CloudBase*.nc

    add_coastlines.sh noaa20_viirs_CldBaseHght_20240605_185031_wgs84_fit.tif \
    --add-colorbar --colorbar-text-color="black" \
    --colorbar-title="VIIRS Cloud Base Height (km)" --add-coastlines \
    --coastlines-outline "black" --coastlines-level 1 \
    --coastlines-resolution=i --add-borders --borders-level 2 \
    --borders-outline "gray" --borders-width 1 --coastlines-width 2 \
    --colorbar-height 125 --colorbar-text-size 100 \
...
.. figure:: ../_static/example_images/VIIRS_CBH_example_with_overlays.png
    :name: VIIRS_CBH_example_with_overlays.png
    :width: 100%
    :align: center
...
.. code-block:: bash
    ...
    polar2grid.sh -r viirs_edr -w geotiff  -p Total_Cloud_Fraction -f JRR-CloudCoverLayers_*.nc

    add_coastlines.sh noaa20_viirs_Total_Cloud_Fraction_20240605_185031_wgs84_fit.tif  \
    --add-colorbar --colorbar-text-color="red" \
    --colorbar-title="VIIRS Total Cloud Fraction (%)" --add-coastlines \
    --coastlines-outline "black" --coastlines-level 1 \
    --coastlines-resolution=i --add-borders --borders-level 2 \
    --borders-outline "gray" --borders-width 1 --coastlines-width 2 \
    --colorbar-tick-marks 0.1 --colorbar-minor-tick-marks 0.05 \
...
.. figure:: ../_static/example_images/VIIRS_TCF_example_with_overlays.png
    :name: VIIRS_TCF_example_with_overlays.png
    :width: 100%
    :align: center
...
please visit the `CSPP LEO Website: <https://cimss.ssec.wisc.edu/cspp/>`_
