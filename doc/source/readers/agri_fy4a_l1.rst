...
.. code-block:: bash
    ...
    geo2grid.sh -r agri_fy4a_l1 -w geotiff -p C02 C03 C08 C10 C12 -f FY4A-_AGRI--*.HDF

    geo2grid.sh -r agri_fy4a_l1 -w geotiff --ll-bbox 100 20 120 40 -p ash dust fog true_color  -f /data/*.HDF
