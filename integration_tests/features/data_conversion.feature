Feature: Testing data conversions
  ...
  Examples: MODIS
      | source            | command                                                                                                                           | output             |
      | modis/input/test1 | crefl gtiff --true-color --false-color --fornav-D 10 --grid-configs ${POLAR2GRID_HOME}/grid_configs/grid_example.conf -g miami -f | modis/output/new_test1 |
...
#     Examples: TEST
#        | source | command | output |
#       |viirs_sdr_day/sdr|viirs_sdr awips -g 211e 211w -f|viirs_sdr_day/output_awips|
#       | clavrx/noaa19/day/data/clavrx_hrpt_noaa19_20170520_2212_42682.l1b.level2.hdf | clavrx scmi -vv --sector-id LCC --compress --letters -p cloud_type cld_temp_acha cld_height_acha -f  | clavrx/newp2g  |
#
#
#
#
