...
entry_points = {
    ...
    'polar2grid.frontend_class': [
        'viirs_edr_flood=polar2grid.readers.mersi2_l1b:Frontend',
        'viirs_edr_active_fires=polar2grid.readers.virr_l1b:Frontend',
    ...
    'polar2grid.frontend_arguments': [
        'viirs_edr_flood=polar2grid.readers.mersi2_l1b:add_frontend_argument_groups',
        'viirs_edr_active_fires=polar2grid.readers.mersi2_l1b:add_frontend_argument_groups',
