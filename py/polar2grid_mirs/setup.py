...
"""Script for installing this polar2grid.mirs package.
...
setup(
    ...
    entry_points={
        'console_scripts': [],
        'polar2grid.frontend_class': ['mirs=polar2grid.mirs:Frontend'],
        'polar2grid.frontend_arguments': ['mirs=polar2grid.mirs:add_frontend_argument_groups']
    }
)
