...
I01_REGEX = r'SVI01.*\.h5'
I02_REGEX = r'SVI02.*\.h5'
I03_REGEX = r'SVI03.*\.h5'
I04_REGEX = r'SVI04.*\.h5'
I05_REGEX = r'SVI05.*\.h5'
M01_REGEX = r'SVM01.*\.h5'
M02_REGEX = r'SVM02.*\.h5'
M03_REGEX = r'SVM03.*\.h5'
M04_REGEX = r'SVM04.*\.h5'
M05_REGEX = r'SVM05.*\.h5'
M06_REGEX = r'SVM06.*\.h5'
M07_REGEX = r'SVM07.*\.h5'
M08_REGEX = r'SVM08.*\.h5'
M09_REGEX = r'SVM09.*\.h5'
M10_REGEX = r'SVM10.*\.h5'
M11_REGEX = r'SVM11.*\.h5'
M12_REGEX = r'SVM12.*\.h5'
M13_REGEX = r'SVM13.*\.h5'
M14_REGEX = r'SVM14.*\.h5'
M15_REGEX = r'SVM15.*\.h5'
M16_REGEX = r'SVM16.*\.h5'
DNB_REGEX = r'SVDNB.*\.h5'
# Geolocation regexes
I_GEO_REGEX = r'GIMGO.*\.h5'
I_GEO_TC_REGEX = r'GITCO.*\.h5'
M_GEO_REGEX = r'GMODO.*\.h5'
M_GEO_TC_REGEX = r'GMTCO.*\.h5'
DNB_GEO_REGEX = r'GDNBO.*\.h5'
DNB_GEO_TC_REGEX = r'GDNBO.*\.h5' # FUTURE: Fix when TC DNB geolocation is available
...
def create_im_file_info(file_kind, file_band, **kwargs):
    ...
    """
    file_band_str = str(int(file_band))
    d = {
    ...
    for k,v in d.items():
        d[k] = d[k].format(file_kind=file_kind, file_band=file_band_str, **kwargs)
    return d

SV_FILE_GUIDE = {
    I01_REGEX: create_im_file_info("I", "01"),
    I02_REGEX: create_im_file_info("I", "02"),
    I03_REGEX: create_im_file_info("I", "03"),
    I04_REGEX: create_im_file_info("I", "04"),
    I05_REGEX: create_im_file_info("I", "05"),
    M01_REGEX: create_im_file_info("M", "01"),
    M02_REGEX: create_im_file_info("M", "02"),
    M03_REGEX: create_im_file_info("M", "03"),
    M04_REGEX: create_im_file_info("M", "04"),
    M05_REGEX: create_im_file_info("M", "05"),
    M06_REGEX: create_im_file_info("M", "06"),
    M07_REGEX: create_im_file_info("M", "07"),
    M08_REGEX: create_im_file_info("M", "08"),
    M09_REGEX: create_im_file_info("M", "09"),
    ...
    DNB_REGEX: {
        K_RADIANCE: '/All_Data/VIIRS-DNB-SDR_All/Radiance',
        K_REFLECTANCE: None,
        K_BTEMP: None,
