...
with the various packages required by the polar2grid python package.
...
python package scripts) must be used to run any
remappings from satellite data to grid format as they setup the rest
of the environment and provide script defaults.
