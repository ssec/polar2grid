...
from polar2grid.drrtv import FrontendOld
import remap
...
through strftime. Current time if no files.""")
    ...
    if args.remove_prev:
        ...
        file_start_time = list(sorted(x for x in FrontendOld.parse_datetimes_from_filepaths(hdf_files) if x is not None))[0]
