...
"""Script for installing this polar2grid.avhrr package.
...
setup(
    ...
    entry_points={
        'console_scripts': [],
        'polar2grid.frontend_class': ['avhrr=polar2grid.avhrr:Frontend'],
        'polar2grid.frontend_arguments': ['avhrr=polar2grid.avhrr:add_frontend_argument_groups']
    }
)
